...
class LowerHierarchicalMNS(ModuleNamingScheme):
    ...
    def det_full_module_name(self, ec):
        ...
        """
        return os.path.join(self.det_module_subdir(ec), self.det_short_module_name(ec).lower())
    ...
    def det_short_module_name(self, ec):
        ...
        """
        return os.path.join(ec['name'], self.det_full_version(ec)).lower()
        ...
        if tc_comps is None:
            ...
            if len(tc_comps) > 0 and tc_comps[0]:
                ...
                if key in COMP_NAME_VERSION_TEMPLATES:
                    ...
                    res = (tc_comp_name.lower(), tc_comp_ver.lower())
                else:
                    if len(tc_comps) == 1:
                        tc_comp = tc_comps[0]
                        res = (tc_comp['name'].lower(), self.det_full_version(tc_comp).lower())
                    else:
    ...
    def det_modpath_extensions(self, ec):
        ...
        if is_compiler or non_system_cuda:
            ...
            paths.append(os.path.join(COMPILER, *comp_name_ver).lower())
