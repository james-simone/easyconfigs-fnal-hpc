...
export EASYBUILD_CONFIGFILES=$EASYBUILD_PREFIX/easyconfigs-fnal-hpc/ebconfig/config_wc.cfg
...
export EASYBUILD_ROBOT_PATHS=$EASYBUILD_PREFIX/easyconfigs-fnal-hpc/wc/el8
export EASYBUILD_EXTERNAL_MODULES_METADATA=$EASYBUILD_PREFIX/easyconfigs-fnal-hpc/wc/el8/*.cfg
